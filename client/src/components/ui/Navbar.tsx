...
const Navbar = () => {
  ...
  const dropdownVariants = {
    ...
    exit: {
      scaleY: 0,
      transition: { delay: 0.2, duration: 0.6, ease: [0.32, 0, 0.36, 1] },
    },
  };
          ...
          >
            <div className="logo-container">
              {theme === "light" ? (
                <img
                  src={logoLight}
                  onClick={() => (window.scrollTo(0, 0), location.reload())}
                ></img>
              ) : (
                <img
                  src={logoDark}
            ...
            <AnimatePresence>
              {isMobileMenuOpen && (
                ...
                >
                  ...
                  >
                    <motion.a
                      href="https://www.linkedin.com/in/quinn-flanigan/"
                      target="_blank"
                      rel="noopener noreferrer"
                      variants={socialLinkVars}
